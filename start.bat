...
start "Backend Server" cmd /c "title Backend Server && python simple_backend.py && pause"
...
start "Frontend Server" cmd /c "title Frontend Server && cd frontend && npm run dev"
